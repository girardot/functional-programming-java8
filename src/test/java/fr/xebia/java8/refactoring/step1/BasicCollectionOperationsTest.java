...
import static fr.xebia.java8.refactoring.step1.BasicCollectionOperations.exchangeRateWithEuro;
import static fr.xebia.java8.refactoring.step1.BasicCollectionOperations.fibonacci;
...
public class BasicCollectionOperationsTest {
    ...
    public void should_return_exchange_rate() {
        assertThat(exchangeRateWithEuro("EUR")).isEqualByComparingTo("1");
        assertThat(exchangeRateWithEuro("GBP")).isEqualByComparingTo("1.38");
        assertThat(exchangeRateWithEuro("USD")).isEqualByComparingTo("0.91");
        assertThat(exchangeRateWithEuro("AUD")).isEqualByComparingTo("0.70");
        assertThat(exchangeRateWithEuro("AZERTY")).isEqualByComparingTo("1");
    }

    @Test
    public void should_return_45_fibonacci_number() {
        assertThat(fibonacci(45)).containsExactly(1L, 1L, 2L, 3L, 5L, 8L, 13L, 21L, 34L, 55L, 89L, 144L, 233L, 377L, 610L, 987L, 1597L, 2584L, 4181L, 6765L, 10946L, 17711L, 28657L, 46368L, 75025L, 121393L, 196418L, 317811L, 514229L, 832040L, 1346269L, 2178309L, 3524578L, 5702887L, 9227465L, 14930352L, 24157817L, 39088169L, 63245986L, 102334155L, 165580141L, 267914296L, 433494437L, 701408733L, 1134903170L);
    }
